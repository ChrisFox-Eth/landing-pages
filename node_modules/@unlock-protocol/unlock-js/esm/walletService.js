...
export default class WalletService extends UnlockService {
  ...
  async deployTemplate(version, callback) {
    const factory = new ethers.ContractFactory(abis[version].PublicLock.abi, bytecode[version].PublicLock, this.signer);
  ...
  async deployUnlock(version, callback) {
    ...
    const factory = new ethers.ContractFactory(abis[version].Unlock.abi, bytecode[version].Unlock, this.signer);
