...
import erc20abi from './erc20abi'; // The SAI contract does not have the symbol method implemented correctly
...
export async function getErc20BalanceForAddress(erc20ContractAddress, address, provider) {
...
export async function getAllowance(erc20ContractAddress, lockContractAddress, provider, signer) {
...
export async function approveTransfer(erc20ContractAddress, lockContractAddress, value, provider, signer) {
